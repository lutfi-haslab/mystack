...
function useDivider(props) {
  ...
  const getDividerProps = (0, import_react.useCallback)(
    (props2 = {}) => ({
      ...
      ...(0, import_utils.mergeProps)(separatorProps, otherProps, props2)
    }),
...
var Divider = (0, import_system.forwardRef)((props, ref) => {
  const { Component, getDividerProps } = useDivider({ ref, ...props });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...getDividerProps() });
});
