...
function useSpinner(originalProps) {
  const [props, variantProps] = (0, import_system.mapPropsVariants)(originalProps, import_theme.spinner.variantKeys);
...
var Spinner = (0, import_system2.forwardRef)((props, ref) => {
  const { domRef, slots, classNames, label, getSpinnerProps } = useSpinner({ ref, ...props });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: domRef, ...getSpinnerProps(), children: [
