...
} from "./chunk-ALQVDQFM.mjs";
import {
  dropdown_item_default
} from "./chunk-SUBVIRYL.mjs";
import {
  useDropdownContext
  ...
  ({
    ...
    return /* @__PURE__ */ jsx(PopoverContent, { children: /* @__PURE__ */ jsx(FocusScope, { contain: true, restoreFocus: true, children: /* @__PURE__ */ jsx(Component, { ...getMenuProps({ ...menuProps }, domRef), className: classNames, children: [...state.collection].map((item) => {
      ...
      if (item.type === "section") {
        return /* @__PURE__ */ jsx(dropdown_section_default, { ...itemProps, itemClasses });
      }
      let dropdownItem = /* @__PURE__ */ jsx(dropdown_item_default, { ...itemProps, classNames: itemClasses });
      if (item.wrapper) {
