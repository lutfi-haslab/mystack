  ...
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_popover.PopoverContent, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_focus2.FocusScope, { contain: true, restoreFocus: true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...getMenuProps({ ...menuProps }, domRef), className: classNames, children: [...state.collection].map((item) => {
      ...
      if (item.type === "section") {
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(dropdown_section_default, { ...itemProps, itemClasses });
      }
      let dropdownItem2 = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(dropdown_item_default, { ...itemProps, classNames: itemClasses });
      if (item.wrapper) {
