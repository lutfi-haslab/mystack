...
function useSpacer(originalProps) {
  const [props, variantProps] = (0, import_system.mapPropsVariants)(originalProps, import_theme.spacer.variantKeys);
...
var Spacer = (0, import_system2.forwardRef)((props, ref) => {
  const { Component, getSpacerProps } = useSpacer({ ...props, ref });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...getSpacerProps() });
});
