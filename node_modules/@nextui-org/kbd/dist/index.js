...
function useKbd(originalProps) {
  const [props, variantProps] = (0, import_system.mapPropsVariants)(originalProps, import_theme.kbd.variantKeys);
...
var Kbd = (0, import_system2.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, { ...getKbdProps(), children: [
    keysContent,
